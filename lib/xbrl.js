/* ===========================================================================
 * lib/xbrl.js  -  Erzeugung der E-Bilanz als XBRL-Instanz
 * ---------------------------------------------------------------------------
 ...
 *    amtliche Taxonomie 6.9 prüfen - siehe tools/validate.js.
 * ========================================================================= */
'use strict';
...
module.exports = { erzeugeXBRL: erzeugeXBRL, erzeugeEBilanz: erzeugeEBilanz };
