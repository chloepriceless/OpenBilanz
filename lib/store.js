 ...
 *
 * Die Daten bleiben vollständig lokal. Der Ordner ./data kann gesichert oder
 * mit Git versioniert werden (revisionssichere Ablage der Buchhaltung).
 * ========================================================================= */
'use strict';
...
function schreibeJSON(datei, obj) {
  init();
  fs.writeFileSync(datei, JSON.stringify(obj, null, 2), 'utf8');
}
